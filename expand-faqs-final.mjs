...
function expandAnswer(answer) {
  // Si ya es largo (más de 400 caracteres), no expandas
...
files.forEach(file => {
  ...
  // Buscar todas las respuestas FAQ y expandirlas
  content = content.replace(/a: '([^']+)'/g, (match, answer) => {
    const expanded_answer = expandAnswer(answer);
